  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-3 gap-2.5">
        <BadgeStat size="sm" icon="wallet" label="Toplam harcama" value={formatTL(totalSpent)} tone="accent2Soft" />
        <BadgeStat size="sm" icon="check" label="Ziyaret sayısı" value={String(visitCount)} tone="accentSoft" />
        <BadgeStat
          size="sm"
          icon="clock"
          label="Son ziyaret"
          value={lastVisitAt ? formatDateTR(lastVisitAt) : "—"}
          tone="block2"
        />
      </div>
